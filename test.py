import torch
import numpy as np
from transfer_matrix import interface_matrix, propagation_matrix, transfer_matrix
...
def test_interface_matrix():
    ...
    T_matrix = interface_matrix(n1, n2, theta1, theta2, wavelength)
...
def test_propagation_matrix():
    ...
    assert np.isclose(calculated_phase_shift, -expected_phase_shift, atol=1e-3), f"Failed: Phase shift = {calculated_phase_shift}"
